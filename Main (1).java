...
public class Main
{
  public static void main (String[]args)
  {
    Scanner sc = new Scanner (System.in);
      System.out.print ("**Ingresa una linea de caracteres: ");
    String linea = sc.nextLine ();
      sc.close ();
    char caracterMasFrecuente = obtenerCaracterMasFrecuente (linea);
      System.
      out.println ("**El caracter que mas veces se repite en la linea es: " +
		   caracterMasFrecuente);
    String lineaModificada = sustituirVocales (linea, caracterMasFrecuente);
      System.out.println ("**La linea modificada es: " + lineaModificada);
    String lineaInvertida = invertirLinea (linea);
      System.out.println ("**La linea invertida es: " + lineaInvertida);
  }
